...
/**
 * Wireframe Plugin Compatibility Notice.
 *
...
function wireframe_plugin_notice_compat() {
	...
	<div class="notice notice-error">
		...
		<p><?php esc_html_e( 'Hey there! Sorry to bother you, but it looks like you are using an older version of WordPress. Wireframe Plugin is only compatible with WordPress 4.9.2 or later. Please deactivate Wireframe Plugin and update WordPress to dismiss this notice. Thank you for using MixaTheme products!', 'wireframe-plugin' ); ?></p>
	</div>
	<?php
}
